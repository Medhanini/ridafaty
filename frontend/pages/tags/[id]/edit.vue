...
const form = reactive({
  ...
  lang: (store.currentTag?.lang ?? 'fr') as 'fr' | 'en' | 'ar',
})
...
<template>
  <div class="mx-auto max-w-lg">
    <div class="mb-6 flex items-center gap-3">
      <NuxtLink to="/tags" class="rounded-lg p-1.5 text-gray-500 hover:bg-gray-100">
    ...
    <div class="rounded-2xl bg-white p-6 shadow-sm">
      ...
      <form class="space-y-5" @submit.prevent="submit">
        ...
        <div class="flex justify-end gap-3 pt-2">
          <NuxtLink to="/tags" class="rounded-lg border border-gray-200 px-4 py-2 text-sm font-medium text-gray-700 hover:bg-gray-50">Cancel</NuxtLink>
          <button
            type="submit"
